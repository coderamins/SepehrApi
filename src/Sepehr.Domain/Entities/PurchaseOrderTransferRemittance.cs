...
{
    public class PurchaseOrderTransferRemittance:AuditableBaseEntity<int>
    {
        ...
        public virtual ICollection<PurchaseOrderTransferRemittanceDetail> Details { get; set; }=new List<PurchaseOrderTransferRemittanceDetail>();    
        public virtual required PurchaseOrderTransferRemittanceStatus TransferRemittanceStatus { get; set; }
