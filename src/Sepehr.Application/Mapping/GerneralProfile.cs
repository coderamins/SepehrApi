...
namespace Sepehr.Application.Mapping
{
    public class GeneralProfile : Profile
    {
        public GeneralProfile()
        {
            ...
            CreateMap<FarePaymentDto, RentPayment>()
            ...
            CreateMap<RentPayment, RentPaymentViewModel>()
                ...
                .ForMember(m => m.OtherCosts, opt => opt.MapFrom(d => d.RentPaymentDetails.Sum(d=>d.LadingExitPermit!=null ? d.LadingExitPermit.OtherAmount: d.UnloadingPermit.OtherCosts)))
                ...
                .ForMember(m => m.CreatedBy, opt => opt.MapFrom(d => d.ApplicationUser == null ? "" : (string.Concat(d.ApplicationUser.FirstName, " ", d.ApplicationUser.LastName))))
                .ForMember(m => m.CreatedDate, opt => opt.MapFrom(d => d.Created.ToShamsiDate()));
