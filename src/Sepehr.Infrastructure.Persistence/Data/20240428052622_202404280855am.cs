...
{
    /// <inheritdoc />
    public partial class _202404280855am : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "PurchaseOrderTransferRemittanceEntrancePermits",
                schema: "sepdb",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ...
                    PurchaseOrderTransferRemittanceId = table.Column<int>(type: "int", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModified = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchaseOrderTransferRemittanceEntrancePermits", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PurchaseOrderTransferRemittanceEntrancePermits_TransferRemittances_PurchaseOrderTransferRemittanceId",
                        column: x => x.PurchaseOrderTransferRemittanceId,
                        principalSchema: "sepdb",
            ...
            migrationBuilder.CreateTable(
                name: "PurchaseOrderTransferRemittanceUnloadingPermits",
                schema: "sepdb",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PurchaseOrderTransferRemittanceEntrancePermitId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UnloadingPermitCode = table.Column<int>(type: "int", nullable: false),
                    PurchaseOrderTransferRemittanceDetailId = table.Column<int>(type: "int", nullable: false),
                    DriverAccountNo = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchaseOrderTransferRemittanceUnloadingPermits", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PurchaseOrderTransferRemittanceUnloadingPermits_PurchaseOrderTransferRemittanceEntrancePermits_PurchaseOrderTransferRemittan~",
                        column: x => x.PurchaseOrderTransferRemittanceEntrancePermitId,
                        principalSchema: "sepdb",
                        principalTable: "PurchaseOrderTransferRemittanceEntrancePermits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                name: "PurchaseOrderTransferRemittanceUnloadingPermitDetails",
                schema: "sepdb",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PurchaseOrderTransferRemittanceUnloadingPermitId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PurchaseOrderTransferRemittanceDetailId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchaseOrderTransferRemittanceUnloadingPermitDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PurchaseOrderTransferRemittanceUnloadingPermitDetails_PurchaseOrderTransferRemittanceUnloadingPermits_PurchaseOrderTransferR~",
                        column: x => x.PurchaseOrderTransferRemittanceUnloadingPermitId,
                        principalSchema: "sepdb",
                        principalTable: "PurchaseOrderTransferRemittanceUnloadingPermits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PurchaseOrderTransferRemittanceUnloadingPermitDetails_TransferRemittanceDetails_PurchaseOrderTransferRemittanceDetailId",
                        column: x => x.PurchaseOrderTransferRemittanceDetailId,
                        principalSchema: "sepdb",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Attachment_PurchaseOrderTransferRemittanceEntrancePermits_PurOrderTransRemittanceEntrancePermitId",
                        column: x => x.PurOrderTransRemittanceEntrancePermitId,
                        principalSchema: "sepdb",
                        principalTable: "PurchaseOrderTransferRemittanceEntrancePermits",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Attachment_PurchaseOrderTransferRemittanceUnloadingPermits_PurOrderTransRemittanceUnloadingPermitId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PurchaseOrderTransferRemittanceUnloadingPermitId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    LadingExitPermitId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RentPayments_PurchaseOrderTransferRemittanceUnloadingPermits_PurchaseOrderTransferRemittanceUnloadingPermitId",
                        column: x => x.PurchaseOrderTransferRemittanceUnloadingPermitId,
                        principalSchema: "sepdb",
                        principalTable: "PurchaseOrderTransferRemittanceUnloadingPermits",
                        principalColumn: "Id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseOrderTransferRemittanceEntrancePermits_PurchaseOrderTransferRemittanceId",
                schema: "sepdb",
                table: "PurchaseOrderTransferRemittanceEntrancePermits",
                column: "PurchaseOrderTransferRemittanceId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseOrderTransferRemittanceUnloadingPermitDetails_PurchaseOrderTransferRemittanceDetailId",
                schema: "sepdb",
                table: "PurchaseOrderTransferRemittanceUnloadingPermitDetails",
                column: "PurchaseOrderTransferRemittanceDetailId");

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseOrderTransferRemittanceUnloadingPermitDetails_PurchaseOrderTransferRemittanceUnloadingPermitId",
                schema: "sepdb",
                table: "PurchaseOrderTransferRemittanceUnloadingPermitDetails",
                column: "PurchaseOrderTransferRemittanceUnloadingPermitId");

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseOrderTransferRemittanceUnloadingPermits_PurchaseOrderTransferRemittanceEntrancePermitId",
                schema: "sepdb",
                table: "PurchaseOrderTransferRemittanceUnloadingPermits",
                column: "PurchaseOrderTransferRemittanceEntrancePermitId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RentPayments_PurchaseOrderTransferRemittanceUnloadingPermitId",
                schema: "sepdb",
                table: "RentPayments",
                column: "PurchaseOrderTransferRemittanceUnloadingPermitId");
