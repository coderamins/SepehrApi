...
{
    /// <inheritdoc />
    public partial class migration_trigger : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            GO
            /****** Object:  Trigger [SepehrDb].[TR_OrderDetailLog]    Script Date: 2/20/2024 10:26:29 PM ******/
            SET ANSI_NULLS ON
            GO
            ...
            -- =============================================
            CREATE TRIGGER [SepehrDb].[TR_OrderDetailLog]
               ON  [SepehrDb].[OrderDetails]
            ...
            migrationBuilder.Sql(@"USE [SepehrDb]
            GO
            /****** Object:  Trigger [SepehrDb].[TR_OrderPaymentLog]    Script Date: 2/20/2024 10:31:40 PM ******/
            SET ANSI_NULLS ON
            GO
            SET QUOTED_IDENTIFIER ON
            GO
            ...
            -- Description:	<Description,,>
            -- =============================================
            CREATE TRIGGER [SepehrDb].[TR_OrderPaymentLog]
               ON  [SepehrDb].[OrderPayments]
               AFTER INSERT,DELETE,UPDATE
            AS 
            BEGIN
            	-- SET NOCOUNT ON added to prevent extra result sets from
            ...
            END; disable trigger [TR_OrderPaymentLog] on [SepehrDb].[OrderPayments];");

            //---------Order Log-----------
            migrationBuilder.Sql(@"USE [SepehrDb]
            GO
            /****** Object:  Trigger [SepehrDb].[TR_OrderLog]    Script Date: 2/20/2024 10:33:16 PM ******/
            SET ANSI_NULLS ON
            GO
            SET QUOTED_IDENTIFIER ON
            GO
            ...
            -- Description:	<Description,,>
            -- =============================================
            CREATE TRIGGER [SepehrDb].[TR_OrderLog]
               ON  [SepehrDb].[Orders]
               AFTER INSERT,DELETE,UPDATE
            AS 
            BEGIN
            ...
            migrationBuilder.Sql(@"USE [SepehrDb]
            GO
            /****** Object:  Trigger [SepehrDb].[TR_CreateWarehouseInventory]    Script Date: 2/20/2024 10:35:05 PM ******/
            SET ANSI_NULLS ON
            GO
            SET QUOTED_IDENTIFIER ON
            GO
            ...
            -- Description:	<Description,,>
            -- =============================================
            CREATE TRIGGER [SepehrDb].[TR_CreateWarehouseInventory]
               ON  [SepehrDb].[ProductBrands] 
               AFTER INSERT
            AS 
            BEGIN
            	-- SET NOCOUNT ON added to prevent extra result sets from
            ...
            migrationBuilder.Sql(@"USE [SepehrDb]
            GO
            /****** Object:  Trigger [SepehrDb].[TR_ProductBrandEvents]    Script Date: 2/20/2024 10:36:21 PM ******/
            SET ANSI_NULLS ON
            GO
            SET QUOTED_IDENTIFIER ON
            GO
            ...
            -- Description:	<Description,,>
            -- =============================================
            CREATE TRIGGER [SepehrDb].[TR_ProductBrandEvents]
               ON  [SepehrDb].[ProductBrands]
               AFTER INSERT,DELETE,UPDATE
            AS 
            BEGIN
            ...
            END; disable trigger [TR_ProductBrandEvents] on [SepehrDb].[ProductBrands];");

            //------------Product Details Event-------------
            migrationBuilder.Sql(@"USE [SepehrDb]
            GO
            /****** Object:  Trigger [SepehrDb].[TR_ProductDetailEvents]    Script Date: 2/20/2024 10:41:06 PM ******/
            SET ANSI_NULLS ON
            GO
            SET QUOTED_IDENTIFIER ON
            GO
            ...
            -- Description:	<Description,,>
            -- =============================================
            CREATE TRIGGER [SepehrDb].[TR_ProductDetailEvents]
               ON  [SepehrDb].[ProductDetails]
               AFTER INSERT,DELETE,UPDATE
            AS 
            BEGIN
            	-- SET NOCOUNT ON added to prevent extra result sets from
            ...
            migrationBuilder.Sql(@"USE [SepehrDb]
            GO
            /****** Object:  Trigger [SepehrDb].[ProductInventoryEvents]    Script Date: 2/20/2024 10:43:04 PM ******/
            SET ANSI_NULLS ON
            GO
            SET QUOTED_IDENTIFIER ON
            GO
            CREATE TRIGGER [SepehrDb].[ProductInventoryEvents]
            ON  [SepehrDb].[ProductInventories]
            AFTER INSERT,DELETE,UPDATE
            AS 
            BEGIN
            ...
            SET NOCOUNT ON;
            END; disable trigger [TR_ProductInventoryEvents] on [SepehrDb].[ProductInventories];");


            //---------------Create Product Official Inventory----------------
            migrationBuilder.Sql(@"USE [SepehrDb]
            GO
            /****** Object:  Trigger [SepehrDb].[TR_CreateProductOfficialInventory]    Script Date: 2/20/2024 10:44:18 PM ******/
            SET ANSI_NULLS ON
            GO
            SET QUOTED_IDENTIFIER ON
            GO
            ...
            -- Description:	<Description,,>
            -- =============================================
            CREATE TRIGGER [SepehrDb].[TR_CreateProductOfficialInventory]
               ON  [SepehrDb].[Products] 
               AFTER INSERT
            AS 
            BEGIN
            	-- SET NOCOUNT ON added to prevent extra result sets from
            	...
            	Begin
            				...
            				BEGIN
            					if(not exists(select * from [SepehrDb].[OfficialWarehoseInventories] 
            						where ProductId=@newProductId and WarehouseId=@warehouseId))
            						begin
            							insert into [SepehrDb].[OfficialWarehoseInventories] 
            ...
            migrationBuilder.Sql(@"USE [SepehrDb]
            GO
            /****** Object:  Trigger [SepehrDb].[TR_ProductEvents]    Script Date: 2/20/2024 10:45:47 PM ******/
            SET ANSI_NULLS ON
            GO
            SET QUOTED_IDENTIFIER ON
            GO
            ...
            -- Description:	<Description,,>
            -- =============================================
            CREATE TRIGGER [SepehrDb].[TR_ProductEvents]
               ON  [SepehrDb].[Products]
               AFTER INSERT,DELETE,UPDATE
            AS 
            BEGIN
            ...
            END; disable trigger TR_ProductEvents on [SepehrDb].[Products];");
        }

        /// <inheritdoc />
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"drop trigger [SepehrDb].[TR_OrderDetailLog]");
            migrationBuilder.Sql(@"drop trigger [SepehrDb].[TR_OrderPaymentLog]");
